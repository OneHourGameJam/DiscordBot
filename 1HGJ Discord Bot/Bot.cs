...
namespace _1HGJ_Discord_Bot
{
	class Bot
	{
		...
		public Bot()
		{
			...
			CreateTextCommand("vote", "Vote on the next theme here: http://onehourgamejam.com/?page=themes, **if you don't have an account yet type __!login__**");
			...
			CreateTextCommand("commands", "Commands:\n\n!help\n!commands\n\n!time\n!theme\n\n!submit\n!vote\n!login");

			CreateTextCommand("help", "The One Hour Game Jam happens every Saturday at 20:00 UTC and ends at 21:00 UTC. You have until the next jam to submit your game.\nJoin us, just have fun and learn!");
